...
int main(void) {
    ...
    while (fgets(usuarios[count_estagiario].nome, 100, pArquivo_usuarios) != NULL) {
        usuarios[count_estagiario].nome[strcspn(usuarios[count_estagiario].nome, "\n")] = 0;
        if (fgets(usuarios[count_estagiario].senha, 100, pArquivo_usuarios) != NULL) {
            usuarios[count_estagiario].senha[strcspn(usuarios[count_estagiario].senha, "\n")] = 0;
            count_estagiario++;
        }
    }
